...
use windows::Win32::UI::WindowsAndMessaging::{
    SPI_GETMOUSESPEED, SPI_GETWHEELSCROLLLINES, SPI_SETMOUSESPEED, SPI_SETWHEELSCROLLLINES,
    SPIF_SENDCHANGE, SPIF_UPDATEINIFILE, SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS,
